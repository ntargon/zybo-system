...
#
# create_vivado_project.tcl: Tcl script for re-creating project 'zybo'
#
# Generated by Vivado on Sun Jun 15 00:18:02 +0900 2025
...
# Create project
create_project ${_xil_proj_name_} ./vivado_proj -part xc7z010clg400-1
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.04367",
   "Default View_TopLeft":"-172,-7",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1040 -y 280 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1040 -y 300 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 210 -y 330 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 3 -x 900 -y 160 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 620 -y 110 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 210 -y 560 -defaultsOSRD
preplace netloc axi_timer_0_interrupt 1 0 4 -10 180 460J 270 NJ 270 1020
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 170 450 230 770J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 190 420
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 470 240 780J
preplace netloc processing_system7_0_DDR 1 1 3 NJ 250 770J 280 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 440J 300 NJ 300 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 430 50n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 110
levelinfo -pg 1 -40 210 620 900 1040
pagesize -pg 1 -db -bbox -sgen -40 -10 1160 660
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zybo.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
